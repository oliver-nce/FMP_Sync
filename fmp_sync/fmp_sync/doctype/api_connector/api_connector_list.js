...
function open_ai_chat(listview) {
	...
	function send_message() {
		...
		frappe.call({
			method:
				"fmp_sync.fmp_sync.doctype.api_connector.api_connector.ai_discover_chat",
...
function generate_from_chat(messages, listview, chat_dialog) {
	frappe.call({
		method:
			"fmp_sync.fmp_sync.doctype.api_connector.api_connector.ai_discover_generate",
		args: { messages: messages },
		freeze: true,
...
function create_connector(data, listview) {
	frappe.call({
		method:
			"fmp_sync.fmp_sync.doctype.api_connector.api_connector.create_connector_from_ai",
